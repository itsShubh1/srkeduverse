...
?>  
    <div class="container-fluid bg-dark pl-0 pr-0"> <!-- Start Course Page Banner -->
      <div class="row">
      <img src="./image/coursesrk.jpg" alt="courses" style="height:490px; width:100%; object-fit:cover; box-shadow:10px;"/>
      </div> 
    ...
    <div class="col-sm text-center text-danger ">
            <h1> <i class="fas fa-book-reader mr-4"></i>All Course</h1>
          </div>
