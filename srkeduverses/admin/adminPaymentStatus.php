...
?>  
   <div class="container" style="width: 20%">
     ...
     <div class="form-group row">
        <label class="offset-sm-3 col-form-label">𝗢𝗿𝗱𝗲𝗿 𝗜𝗱 : </label>
        <div>
          <input class="form-control mx-3"  style="width:100%" id="ORDER_ID" tabindex="1" maxlength="20" size="20" name="ORDER_ID" autocomplete="off" value="<?php echo $ORDER_ID ?>">
        </div>
        <div>
        <br></br>
